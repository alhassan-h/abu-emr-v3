...
class Mission extends Component {
    ...
    render() { 
        return ( 
            ...
            The Mission of ABUTH is to provide compassionate, accessible, high quality, 
            ...
            <br/>
            <p className = "text-white container">
            ABUTH will be an innovative, leading regional health system dedicated to advancing the 
