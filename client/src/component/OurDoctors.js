    ...
    render() { 
        return (     <div>
            <Carousel className ="container" style={{paddingLeft:100 ,paddingRight:100}}>
                ...
                <Card.Body>
                  <Card.Title className = "text-warning">Dr. Josepth Isaac</Card.Title>
                ...
                <Card.Body>
                  <Card.Title className = "text-warning">Dr. Amina Isma'il</Card.Title>
                ...
                <Card.Body>
                  <Card.Title className = "text-warning">Dr. Ahmadu Bello</Card.Title>
                  <Card.Subtitle>Cardiologist</Card.Subtitle>
                  <Card.Text>
